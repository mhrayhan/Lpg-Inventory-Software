...
const InputField = ({ tittle, price, setQty, setPrice, totalValue, name, qtyname }) => {



  return (
    <div className='lg:w-4/5 w-full grid grid-cols-9 gap-1 '>
      <p className='col-span-2 lg:text-lg text-sm flex items-center bg-gray-400 text-white border lg:p-2 pl-1 rounded-md'>{tittle}</p>
